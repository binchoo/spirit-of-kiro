...
import { validateEnvironmentVariables, validateAWSConnectivity } from './utils/config-validator';
...
/**
 * Initialize server with validation
 */
async function initializeServer() {
  console.log('🚀 Starting Spirit of Kiro Server...');
  ...
  try {
    ...
    console.error('Please check your configuration and AWS setup.');
    process.exit(1);
  }
}
